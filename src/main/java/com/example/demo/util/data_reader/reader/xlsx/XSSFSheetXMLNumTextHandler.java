...
/**
 * number 를 그대로의 값을 text 로 읽기 위해서 해당 부분을 value 그대로 읽기 처리한다.
 * 
 * 원본 참조.
 * {@link XSSFSheetXMLHandler}
 */
//@Slf4j
public class XSSFSheetXMLNumTextHandler extends DefaultHandler {
   ...
   private Styles stylesTable; // number format style 을 주석처리함.
    ...
    */
   public XSSFSheetXMLNumTextHandler(
           Styles styles,
           Comments comments,
...
//               }
        	   // KJK NUMBER style 없이 처리하기 위해서 모두 주석처리 함.
           }
       }
   }
...
//                   log.error("NUMBER toString:{}", n);
//                   if ( "General".equals(this.formatString))
