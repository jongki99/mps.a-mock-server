 ...
 */
@Slf4j
public class MultiFilePinNumMapReader extends AbsMultiFileMapTypeReader<SamplePinNumDto> {
	
	
	public MultiFilePinNumMapReader(int rowsSize, ReadFileTypeEnum readDataTypeEnum) {
	...
	protected Class<SamplePinNumDto> getRowClass() {
		// 기본생성자가 필요하다. newInstance() 가 그런 효과인듯.
	...
	public static void main(String[] args) throws Exception {
		log.debug("구현 테스트. "+MultiFilePinNumMapReader.class.getSimpleName());
